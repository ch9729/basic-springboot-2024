...
- Spring Boot JPA 프로젝트 생성 
    - 명령 팔레트로 시작, Spring Initialrz : Create a Gradle Project...
...
- Spring Boot JPA 프로젝트 개발시작
    ...
    3. MVC패턴에 맞춰서 각 기능별로 폴더를 생성(conntroller, service, entity...)
...
- Spring Boot JPA 프렉트 개발 계속
    1. jUnit 테스트로 CPUD 확인 
    ...
    7. /templates/board/detail.html 생성
        ...
        <img src="https://raw.githubusercontent.com/ch9729/basic-springboot-2024/main/images/sp003.png" width="730">
...
- Spring Boot JPA 프로젝트 개발 계속
    ...
    3. list.html, detail.html 레이아웃 템플릿 사용
    ...
    7. /templates/BoardController.java create() GetMapping 메서드 작성
    ...
    17. (문제) 각 입력창에 공백을 넣었을 때 입력되는 문제 @NotEmpty는 스페이스를 허용 -> @NotBlank로 변경
        ...
        <img src="https://raw.githubusercontent.com/ch9729/basic-springboot-2024/main/images/sp005.png" width="730">
...
- Spring Boot JPA 프로젝트 개발 계속
    ...
    1. 페이징(중요!)
        ...
        <img src="https://raw.githubusercontent.com/ch9729/basic-springboot-2024/main/images/sp006.png" width="730">
...
- Spring Boot JPA 프로젝트 개발 계속
    ...
    2. 마크다운 적용, 마크다운 에디터 추가
        ...
        <img src="https://raw.githubusercontent.com/ch9729/basic-springboot-2024/main/images/sp010.png" width="730">
...
- Spring Boot JPA 프로젝트 개발 계속
    ...
    2. AWS 사용
        ...
        - 설정 변경
            ...
            > hostname
            > sudo hostnamectl set-hostname ch9729
            > sudo reboot (서버 재시작)
            ...
            ```
        - VSCode
            - Grade for java > Tasks > build > bootJar
            - *-SNAPSHOT.jar 생성 확인
        - FileZilla
            - *.jar > AWS로 전송
        - PuTTY
...
- Spring Boot JPA 프로젝트 개발 계속
    ...
    2. 비밀번호 초기화
        ...
        - 네이버 메일 SMTP 설정 > 환경설정 > POT3/IMAP 설정

            <img src="https://raw.githubusercontent.com/ch9729/basic-springboot-2024/main/images/sp012.png" width="730">
...
- Spring Boot JPA 프로젝트 개발 계속
    ...
    1. 비밀번호 초기화(계속)
        ...
        - /service/MailService.java에 메일전송 메서드 생성, 수정
            ...
            <img src="https://raw.githubusercontent.com/ch9729/basic-springboot-2024/main/images/sp013.png" width="730">
        ...
        - /service/MemberService.java에 setMember() 메서드 추가
            ...
            <img src="https://raw.githubusercontent.com/ch9729/basic-springboot-2024/main/images/sp014.png" width="730">
...
- 리액트 개요
    - 서버사이드 -> 백엔드
    - 클라이언트사이드 -> 프론트엔드
    - 프론테엔드 : html+css+js(html, jsp, aspx, php, ...)
...
- 리액트 기초공부
    ...
    6. 목록 표시
        ...
        - 각 child 요소마다 key 속성이 필요(없으면 경고)
            ...
            <img src="https://raw.githubusercontent.com/ch9729/basic-springboot-2024/main/images/react001.png" width="730">

    7. 이벤트 핸들링
        - form + onSubmit, tag + onClick
        - 이벤트 파라미터 전달
        - 파라미터가 필요해서 함수뒤에 ()를 쓰면 이벤트 순서에 따라 플레시후 자동실행됨
    ...
    8. 컴포넌트 간 데이터 전달
        ...
        - props.속성이름.key 이름
            ...
            <img src="https://raw.githubusercontent.com/ch9729/basic-springboot-2024/main/images/react002.png" width="730">
    ...
    10. Hooks
        - use로 시작하는 함수를 Hooks 라고 호칭. State, Effect외 잘안씀
...
- Spring Boot React연동 프로젝트 개발 계속
    ...
    5. backborad RestAPI 추가
        - /restcontroller/RestBoardController.java 생성, BoardController에 있는 메서드 복사
        - (문제)Spring Boot와 Rest API 간의 리턴데이터 차이때문에 100% 호환이 안됨
        - (문제!) Spring Boot에서 만든 Entity는 Board와 Reply 등의 OneToMany / ManyToOne 가 JSON으로 변환할 때 문제발생!
    ...
    6. frontboard 개발 계속
        ...
        - 테이블 내용을 boardList.map() 리스트 디스플레이
